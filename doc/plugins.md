...
To know more about this, you can read the [Plugin types](developer/plugin_types.md) page from de [developer section](developer/developer.md).
...
* [es.upv.paella.blackBoardPlugin](plugins/es.upv.paella.blackBoardPlugin2.md)
