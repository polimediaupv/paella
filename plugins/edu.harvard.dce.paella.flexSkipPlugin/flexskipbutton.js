Class ("paella.plugins.FlexSkipPlugin",paella.ButtonPlugin, {
  ...
  getSubclass:function() { return 'flexSkip_' + this.config.direction + '_' + this.config.seconds; },
  getName:function() { return "edu.harvard.dce.paella.flexSkipPlugin"; },
  getIndex:function() {return 121;},
  formatMessage: function() {
    return this.config.direction + ' ' + this.config.seconds + ' seconds';
  },
  getDefaultToolTip:function() { return base.dictionary.translate(this.formatMessage()); },
...
Class ("paella.plugins.FlexSkipPluginForward", paella.plugins.FlexSkipPlugin, {
  getIndex:function() {return 122;},
  getName:function() { return "edu.harvard.dce.paella.flexSkipPluginForward"; }
});
